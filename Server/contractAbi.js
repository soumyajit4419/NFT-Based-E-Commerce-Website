    ...
    outputs: [
      {
        components: [
          { internalType: "uint256", name: "tokenId", type: "uint256" },
          {
            ...
            internalType: "struct ItemNFT_V1.Warranty",
            name: "warrentyDetails",
            type: "tuple"
          }
        ],
        internalType: "struct ItemNFT_V1.NFTDetails[]",
        name: "",
        type: "tuple[]"
      }
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct ItemNFT_V1.Product",
        name: "",
        type: "tuple"
      }
    ],
